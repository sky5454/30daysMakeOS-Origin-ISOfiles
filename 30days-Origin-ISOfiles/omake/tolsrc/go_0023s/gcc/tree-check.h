...
#define SUBOBJECT_CHECK(t)	TREE_CHECK (t, SUBOBJECT)
#define CTOR_STMT_CHECK(t)	TREE_CHECK (t, CTOR_STMT)
...
#define NEW_ARRAY_EXPR_CHECK(t)	TREE_CHECK (t, NEW_ARRAY_EXPR)
#define NEW_ANONYMOUS_ARRAY_EXPR_CHECK(t)	TREE_CHECK (t, NEW_ANONYMOUS_ARRAY_EXPR)
#define NEW_CLASS_EXPR_CHECK(t)	TREE_CHECK (t, NEW_CLASS_EXPR)
#define THIS_EXPR_CHECK(t)	TREE_CHECK (t, THIS_EXPR)
#define CASE_EXPR_CHECK(t)	TREE_CHECK (t, CASE_EXPR)
#define DEFAULT_EXPR_CHECK(t)	TREE_CHECK (t, DEFAULT_EXPR)
#define TRY_EXPR_CHECK(t)	TREE_CHECK (t, TRY_EXPR)
#define CATCH_EXPR_CHECK(t)	TREE_CHECK (t, CATCH_EXPR)
#define SYNCHRONIZED_EXPR_CHECK(t)	TREE_CHECK (t, SYNCHRONIZED_EXPR)
#define THROW_EXPR_CHECK(t)	TREE_CHECK (t, THROW_EXPR)
#define CONDITIONAL_EXPR_CHECK(t)	TREE_CHECK (t, CONDITIONAL_EXPR)
#define INSTANCEOF_EXPR_CHECK(t)	TREE_CHECK (t, INSTANCEOF_EXPR)
#define NEW_ARRAY_INIT_CHECK(t)	TREE_CHECK (t, NEW_ARRAY_INIT)
#define CLASS_LITERAL_CHECK(t)	TREE_CHECK (t, CLASS_LITERAL)
#define JAVA_EXC_OBJ_EXPR_CHECK(t)	TREE_CHECK (t, JAVA_EXC_OBJ_EXPR)
